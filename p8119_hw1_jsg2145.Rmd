...
$P(Y_1 = Y_2 = 1) - K^2 = P(Y_1 = 1, Y_2 = 1) - [f_0(1-p)^2 + f_12p(1-p) + f_2p^2]^2$

$P(Y_1 = 1, Y_2 = 1) = P(Y_1 = 1)P(Y_2 = 1)$
...
Pedigree C: recessive, not dominant, because carriers would have the disease and thus 3 and 4 would be monozygotic.

Pedigree D: dominant or recessive

Pedigree E: recessive, not dominant, because 13 and 14 would have no recessive dominant allele to pass to 20.
